...
public final class Quote {
    ...
    /**
     * Creates new Quote object from the value following the patterns storeName:price:discountCode
    ...
    public static Quote newQuote(String value) {
        ...
        return new Quote(values[0], 1500, Discount.Code.valueOf(values[2]));
    }
